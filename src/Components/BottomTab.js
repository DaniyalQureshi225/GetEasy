    ...
    return(
        ...
        onPress={onPressHome}
          ...
          <Image
            source={home}
            resizeMode="contain"
            style={{width: wp('5%'), height: wp('5%'), tintColor:isHome? Color.white : null}}
          />
          <Text style={{color:isHome ? Color.white : null}}>Hotel</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Image
            source={flight}
            resizeMode="contain"
            style={{width: wp('5%'), height: wp('5%'), tintColor:isFlight ? Color.white : null}}
          />
          <Text style={{color:isFlight? Color.white : null}}>Flights</Text>
        </TouchableOpacity>
        ...
        onPress={onPressCar}
          ...
          <Image
            source={car22}
            resizeMode="contain"
            style={{width: wp('5%'), height: wp('5%'), tintColor:isCar ? Color.white : null }}
          />
          <Text style={{color:Color.white}}>Car</Text>
        </TouchableOpacity>
        ...
        onPress={onPressProfile}
          ...
          <Image
            source={pro}
            resizeMode="contain"
            style={{width: wp('5%'), height: wp('5%'), tintColor: isProfile ? Color.white : null}}
          />
